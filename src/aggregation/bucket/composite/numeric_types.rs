/// This modules helps comparing numerical values of different types.
...
/// When the target representation cannot exactly represent the source value,
/// the next representable value is returned (or AfterLast if it is larger than
/// the largest representable value).
///
/// All functions assume that f64 values are not NaN.
